...
#define UE_PROJECT_NAME MediaEngineering
#define UE_TARGET_NAME MediaEngineeringEditor
#define UE_MODULE_NAME "MediaEngineering"
...
#define MEDIAENGINEERING_API DLLEXPORT
